...
export function Topbar({ onOpenSidebar }: TopbarProps) {
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-white/10 bg-[#0b0b0b]/78 shadow-[0_10px_30px_rgba(0,0,0,0.18)] backdrop-blur-2xl">
      <div className="mx-auto flex h-20 w-full max-w-[1480px] items-center justify-between gap-3 px-4 sm:px-5 lg:px-10">
        <div className="flex min-w-0 flex-1 items-center gap-3">
          ...
          <BrandMark compact className="sm:hidden" markClassName="h-10 w-10" />
        ...
        <div className="flex shrink-0 items-center gap-2">
          ...
          <div className="ml-0 flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-2 py-2 shadow-card backdrop-blur sm:gap-3 sm:px-3">
            ...
            <div className="flex h-10 w-10 items-center justify-center rounded-full border border-primary/35 bg-primary text-sm font-bold text-primary-foreground shadow-soft">
              {initials}
            </div>
            <Button
              variant="ghost"
